package jp.co.trattoria.chapter3_8;
 ...
 */
public class ColorTransformerDemoEx extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		Image image3 = transform(image, colorTransformer(width, height, 10, Color.GRAY));
